  ...
  const benefits = [
    {
      ...
      description: 'All video trimming happens locally in your browser. Your files never leave your device.',
      icon: <SecurityIcon fontSize="large" color="success" />
    },
    {
      title: 'No Upload Required',
      description: 'Trim video files directly in your browser without uploading to any server.',
      icon: <CloudOffIcon fontSize="large" color="info" />
    },
    {
      title: 'Always Free',
      description: 'Trim unlimited video files with no restrictions, watermarks, or hidden fees.',
      icon: <MoneyOffIcon fontSize="large" color="warning" />
    },
    {
      title: 'Frame-Accurate Precision',
      description: 'Cut videos with precise frame-level accuracy for professional results.',
    ...
    <Root>
      ...
      <Helmet>
        ...
        <meta
          ...
          content="Trim and cut videos with frame-accurate precision. Remove unwanted parts locally — no watermark, private & fast."
        />
        <meta property="og:title" content={`Cut Video Online For Free | ${APP_INFO.name}`} />
        <meta property="og:image" content="/images/landing/video-trimmer-hero.png" />
        ...
        <meta name="twitter:image" content="/images/landing/video-trimmer-hero.png" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "How accurate is the video trimming?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Our video trimmer provides frame-accurate precision, allowing you to cut videos down to the exact frame you want. This ensures professional-quality results with no unwanted content in your trimmed videos."
                }
              },
              {
                "@type": "Question",
                "name": "Will trimming reduce video quality?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "No! Our trimmer uses lossless cutting when possible, meaning the original video quality is preserved. The trimmed video maintains the same resolution, bitrate, and codec as the original file."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Absolutely! All trimming happens locally in your browser using WebAssembly. Your videos never leave your device or get uploaded to any server. This ensures complete privacy and security."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "We support all major video formats including MP4, MOV, AVI, MKV, WebM, WMV, FLV, and many more. The trimmed output will maintain the same format as your input file."
                }
              },
              {
                "@type": "Question",
                "name": "Is there a limit on video duration or file size?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "File size limits depend on your device's available memory. Generally, videos up to several GB can be processed without issues. There are no artificial restrictions on video duration or trimming length."
                }
              }
            ]
          })}
        ...
        <Container maxWidth="lg" sx={{ display: 'flex', alignItems: 'center', pt: { xs: 10, md: 20 } }}>
          <Grid container spacing={6} alignItems="center" flexDirection={{ xs: 'column-reverse', md: 'row' }}>
            <Grid size={{ xs: 12, md: 6, lg: 7 }}>
              ...
              >
                Trim and cut videos with frame-accurate precision. Remove unwanted parts locally — no watermark, private & fast.
              </Typography>
              ...
              >
                <Typography variant="body1" sx={{ display: 'flex', alignItems: 'center', fontWeight: 500 }}>
                  ...
                  Frame-accurate precision with lossless quality
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid size={{ xs: 12, md: 6, lg: 5 }}>
              <Box sx={{ textAlign: 'center' }}>
                <img
                  src="/images/landing/video-trimmer-hero.png"
                  alt="Video Trim Tool Interface"
                  style={{
                    width: '100%',
                    maxWidth: 400,
                    height: 'auto',
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Select your video file or drag & drop it into the trimmer
                </Typography>
              </Box>
            </Grid>
            <Grid size={{ xs: 12, sm: 4 }}>
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Use the slider or controls to set precise start and end points
                </Typography>
              </Box>
            </Grid>
            <Grid size={{ xs: 12, sm: 4 }}>
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Get your trimmed video with preserved quality and no watermarks
                </Typography>
              </Box>
            </Grid>
          </Grid>
        ...
        <Container maxWidth="md" sx={{ py: 10 }}>
          ...
          <Accordion elevation={0} sx={{ mb: 2, bgcolor: alpha(theme.palette.background.paper, 0.5), border: `1px solid ${theme.palette.divider}` }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography variant="h6" fontWeight={600}>How accurate is the video trimming?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Our video trimmer provides frame-accurate precision, allowing you to cut videos down to the exact frame you want.
                This ensures professional-quality results with no unwanted content in your trimmed videos.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion elevation={0} sx={{ mb: 2, bgcolor: alpha(theme.palette.background.paper, 0.5), border: `1px solid ${theme.palette.divider}` }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography variant="h6" fontWeight={600}>Will trimming reduce video quality?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                No! Our trimmer uses lossless cutting when possible, meaning the original video quality is preserved.
                The trimmed video maintains the same resolution, bitrate, and codec as the original file.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion elevation={0} sx={{ mb: 2, bgcolor: alpha(theme.palette.background.paper, 0.5), border: `1px solid ${theme.palette.divider}` }}>
            ...
            <AccordionDetails>
              <Typography>
                Absolutely! All trimming happens locally in your browser using WebAssembly. Your videos never leave
          ...
          <Accordion elevation={0} sx={{ mb: 2, bgcolor: alpha(theme.palette.background.paper, 0.5), border: `1px solid ${theme.palette.divider}` }}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                The trimmed output will maintain the same format as your input file.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion elevation={0} sx={{ bgcolor: alpha(theme.palette.background.paper, 0.5), border: `1px solid ${theme.palette.divider}` }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography variant="h6" fontWeight={600}>Is there a limit on video duration or file size?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                File size limits depend on your device's available memory. Generally, videos up to several GB
                can be processed without issues. There are no artificial restrictions on video duration or trimming length.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Container>
      ...
      <section className="cta">
        <Container maxWidth="md" sx={{ pb: 10 }}>
          ...
          >
            <CropIcon sx={{ fontSize: 60, mb: 2 }} />
            <Typography variant="h3" component="h2" gutterBottom fontWeight={700}>
              Ready to Trim Your Video?
            </Typography>
            <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
              Start trimming your video files now with our free, secure, and frame-accurate tool.
            </Typography>
