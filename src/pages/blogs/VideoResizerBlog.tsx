  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      <Helmet>
        ...
        <meta property="og:url" content="https://fileapps.click/tools/video/resize-blog" />
        <meta property="og:site_name" content="FileApps" />
        <link rel="canonical" href="https://fileapps.click/tools/video/resize-blog" />
      ...
      <Paper sx={{ p: 4 }}>
        ...
        <Box>
          ...
          <Typography variant="h4" component="h2" mt={2}>Step-by-Step: Resize Videos in Browser</Typography>
          ...
          <Box mt={4} textAlign="center">
            ...
            <Button color='warning' size='large' href="/tools/video/resize-landing" variant="outlined" sx={{ ml: 2 }}>Features</Button>
          </Box>
        </Box>
      </Paper>
    </Container>
