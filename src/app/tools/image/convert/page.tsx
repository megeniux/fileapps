...
const data = seoDataMap["image-convert"];

export const metadata: Metadata = {
  title: "Image converter",
  description: data?.metaDescription ?? "Free online image converter — no upload required.",
  alternates: { canonical: "https://fileapps.click/tools/image/convert" },
};
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Image converter", item: "https://fileapps.click/tools/image/convert" },
    ],
  };
  ...
  const howToSchema = data ? {
    ...
    totalTime: "PT2M",
    tool: { "@type": "HowToTool", name: "FileApps Image converter" },
  ...
  return (
    <>
      ...
      <ToolHero toolId="image-convert" />
      <ImageConvertClient />
      <ToolContentSection toolId="image-convert" />
      <ToolSeoContent toolId="image-convert" />
    </>
  );
}
