...
const data = seoDataMap["image-crop"];

export const metadata: Metadata = {
  title: "Image cropper",
  description: data?.metaDescription ?? "Free online image cropper — no upload required.",
  alternates: { canonical: "https://fileapps.click/tools/image/crop" },
};
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Image cropper", item: "https://fileapps.click/tools/image/crop" },
    ],
  };
  ...
  const howToSchema = data ? {
    ...
    totalTime: "PT2M",
    tool: { "@type": "HowToTool", name: "FileApps Image cropper" },
  ...
  return (
    <>
      ...
      <ToolHero toolId="image-crop" />
      <ImageCropClient />
      <ToolContentSection toolId="image-crop" />
      <ToolSeoContent toolId="image-crop" />
    </>
  );
}
