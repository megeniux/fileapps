...
const data = seoDataMap["audio-trim"];

export const metadata: Metadata = {
  title: "Audio trimmer",
  description: data?.metaDescription ?? "Free online audio trimmer — no upload required.",
  alternates: { canonical: "https://fileapps.click/tools/audio/trim" },
};
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Audio trimmer", item: "https://fileapps.click/tools/audio/trim" },
    ],
  };
  ...
  const howToSchema = data ? {
    ...
    totalTime: "PT2M",
    tool: { "@type": "HowToTool", name: "FileApps Audio trimmer" },
  ...
  return (
    <>
      ...
      <ToolHero toolId="audio-trim" />
      <AudioTrimClient />
      <ToolContentSection toolId="audio-trim" />
      <ToolSeoContent toolId="audio-trim" />
    </>
  );
}
