...
const data = seoDataMap["video-convert"];

export const metadata: Metadata = {
  title: "Video converter",
  description: data?.metaDescription ?? "Free online video converter — no upload required.",
  alternates: { canonical: "https://fileapps.click/tools/video/convert" },
};
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Video converter", item: "https://fileapps.click/tools/video/convert" },
    ],
  };
  ...
  const howToSchema = data ? {
    ...
    totalTime: "PT2M",
    tool: { "@type": "HowToTool", name: "FileApps Video converter" },
  ...
  return (
    <>
      ...
      <ToolHero toolId="video-convert" />
      <VideoConvertClient />
      <ToolContentSection toolId="video-convert" />
      <ToolSeoContent toolId="video-convert" />
    </>
  );
}
