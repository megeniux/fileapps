...
const data = seoDataMap["video-trim"];

export const metadata: Metadata = {
  title: "Video trimmer",
  description: data?.metaDescription ?? "Free online video trimmer — no upload required.",
  alternates: { canonical: "https://fileapps.click/tools/video/trim" },
};
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Video trimmer", item: "https://fileapps.click/tools/video/trim" },
    ],
  };
  ...
  const howToSchema = data ? {
    ...
    totalTime: "PT2M",
    tool: { "@type": "HowToTool", name: "FileApps Video trimmer" },
  ...
  return (
    <>
      ...
      <ToolHero toolId="video-trim" />
      <VideoTrimClient />
      <ToolContentSection toolId="video-trim" />
      <ToolSeoContent toolId="video-trim" />
    </>
  );
}
